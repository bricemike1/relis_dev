...
if(isset($_POST['submit_form'])){
	...
	if(!empty($error)){
		...
		if (!$link) {
			//die('Database hosts connection error : ' . mysqli_error($link));
			...
			if (mysqli_query($link,$sql )) {
				...
				if (!$db_selected) {
					...
					install_form($_POST,array('Database connection error : '. mysqli_error($link)));
				}else{
				...
				install_form($_POST,array('Database not created : '. mysqli_error($link)));
			}
