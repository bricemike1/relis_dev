<?php //sms_lechanceux
function get_classification_sms_lechanceux(){
...
$result['project_short_name']='sms_lechanceux';
...
$config['classification']['fields'][ 'tool']=array( 		
	'category_type'=>'IndependantDynamicCategory',		
 	...
 	array_push($initial_values, "FreeMarker");
...
$report['year_template_style']['values']['field']='template_style';
$report['year_template_style']['values']['style']='select';
$report['year_template_style']['values']['title']='Template style';  
$report['year_template_style']['reference']['field']='year';
 $report['year_template_style']['reference']['style']='select';
 $report['year_template_style']['reference']['title']='Year';  
  $charts=array();
   	array_push($charts, "line");
  $report['year_template_style']['chart']=$charts;
$report['design_time_year']['type']='compare';
$report['design_time_year']['title']='Evolution of design-time input type'; 		
$report['design_time_year']['id']='design_time_year';
$report['design_time_year']['link']='false'; 
$report['design_time_year']['values']['field']='design_time';
$report['design_time_year']['values']['style']='select';
$report['design_time_year']['values']['title']='Design-time input type';  
$report['design_time_year']['reference']['field']='year';
 $report['design_time_year']['reference']['style']='select';
 $report['design_time_year']['reference']['title']='Year';  
  $charts=array();
   	array_push($charts, "line");
  $report['design_time_year']['chart']=$charts;
$report['design_time']['type']='simple';
$report['design_time']['title']='Design-time input type'; 		
$report['design_time']['id']='design_time';
$report['design_time']['link']='false'; 
$report['design_time']['values']['field']='design_time';
$report['design_time']['values']['style']='select';
$report['design_time']['values']['title']='Design-time input type';  
$charts=array();
 	array_push($charts, "pie");
 	array_push($charts, "bar");
$report['design_time']['chart']=$charts;
...
$report['tools']['values']['title']='Tool';  
$charts=array();
 	array_push($charts, "bar");
 	array_push($charts, "pie");
