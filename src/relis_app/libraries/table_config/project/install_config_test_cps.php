<?php //test_cps
function get_classification_test_cps(){
$reference_tables=array();//from nowit will worklike this
$config=array();
$result['class_action']='override';
$result['screen_action']='noover';
$result['qa_action']='override';
$result['project_title']='Test CPS';
$result['project_short_name']='test_cps';
...
array_push($screening['exclusion_criteria'], "Paper reports on modelling of CPS");
