<?php //mt_test2
function get_classification_mt_test2(){
$reference_tables=array();//from nowit will worklike this
$config=array();
$result['project_title']='MDE Test2';
$result['project_short_name']='mt_test2';
...
$config['classification']['fields'][ 'ratio']=array( 		
	'category_type'=>'FreeCategory',		
 	'field_title'=>'Ratio',
 	'input_type'=>'text',
 	'field_size'=>20,
...
$config['intent_relation']['fields'][ 'domain1']=array( 		
	'category_type'=>'DependentDynamicCategory',		
 	'field_title'=>'Domain',	
 	'field_type'=>'int',
 	'field_size'=>11,
 //	'field_value'=>'normal',
 	...
 	'input_type'=>'select',
 	'input_select_source'=>'table',
 	'input_select_values'=>'domain',//à corriger seul les category sur le root sont supportés pour le moment
 	'on_add'=>'enabled',
 	'on_edit'=>'enabled',
 	'compute_result'=>'no',
 	'on_list'=>'show'				
