	...
	<!-- page content -->
        ...
        ?>         
       <div>   
       <p ><b><i>Screening completion : <?php echo "$paper_screened /  $all_papers -> ".  $screen_completion?>% </i></b></p>       
       <div class="progress">
<div class="progress-bar progress-bar-success" data-transitiongoal="20" style=" width:<?php echo $screen_completion?>%" aria-valuenow="20"></div>
</div>
        ...
        <div>
             <p class='lead '>Paper : <?php echo $paper_title?></p>
                  ...
                  ?>
		                  ...
		                  <a href="<?php echo $paper_link?>" target="_blank" style="color:#aa7777;"><img src='<?php echo base_url() ?>cside/images/pdf.jpg'/></a>
		                 </p>
                 ...
                 <?php }?>
                  ...
                  <div class="ln_solid"></div>
                   ...
                   $attributes = array('class' => 'form-horizontal form_content','onsubmit' => " return  validate_screen()");
                    ...
                    echo form_open('relis/manager/save_screening', $attributes); ?>
                    ...
                    <button class="btn  btn-lg" type="button" onclick="include_paper()">Include</button> &nbsp &nbsp &nbsp
                    <button class="btn btn-danger btn-lg" type="button" onclick="exclude_paper()">Excluded</button>
                    <br/>
                    </div>
                    <br/><br/>
                    <?php
                  ...
                  //  echo checkbox_form_bm('Not sure ','idccx','idccx'); 
                   $save_caption=(!empty($operation_type) AND $operation_type=='edit')?lng('Save'):lng('Save and Next');
                    ...
                    <input type="hidden" name="operation_source"  id="operation_source"  value="<?php echo !empty($operation_source)?$operation_source:'list_screen/mine_screen'?>" />
                     ...
                     <input type="hidden" name="screen_type"  id="screen_type"  value="<?php echo $screen_type ?>" />
                     <div class="ln_solid"></div>
                       <div style='text-align:center'>
                   
                   <button class="btn btn-info btn-lg" type="submit" > <?php echo $save_caption ;?> </button> 
                    <br/>
                    </div>
                    </form>
                <?php }?>    
                  ...
                  <div style='text-align:center'class="screen_decision_include">
                    ...
                    <button class="btn btn-success btn-lg" type="button" onclick="include_paper()">Included</button> &nbsp &nbsp &nbsp
