<?php 
//Some informations have been hard coded for form validation
function get_config_new_user() {
		...
		$set_config=array(
				...
				'table_id'=>'new_users',
				'table_active_field'=>'new_users',
				'main_field'=>'new_users'
		);
		
		$Conf=new $ci->entityconf_lib($set_config);
		$Conf->set_config_id("Brice mike");
		...
		exit;
		$config['config_id']='new_users';
		$config['table_name']=table_name('new_users');
