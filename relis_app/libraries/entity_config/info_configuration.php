...
function get_info() {
	...
	$fields['info_type']=array(
			...
			'input_select_values'=>array('Home' => 'Home',
					'Home' => 'Home',
					'Features' => 'Features',
					'Help' => 'Help',			
					'Reference' => 'Reference'			
	...
	$operations['list_info']=array(
			...
			'fields'=>array(
					...
					'info_title'=>array('link'=>array(
								'url'=>'op/display_element/detail_info/',
								'id_field'=>'info_id',
								'trim'=>'0'
							)),		   	
					//'info_desc'=>array(),		   	
			...
			'list_links'=>array(
					...
					'edit'=>array(
							...
							'title'=>'Edit',
							'icon'=>'edit',
							'url'=>'op/edit_element/edit_info/',
								),
					'delete'=>array(
							'label'=>'Delete',
							'title'=>'Delete ',
							'icon'=>'trash',
							'url'=>'op/delete_element/remove_info/'
					) 
			),
	...
	$operations['add_info']=array(
			...
			'redirect_after_save'=>'op/entity_list/list_info',
	...
	$operations['detail_info']=array(
			...
			'top_links'=>array(
					'edit'=>array(
							...
							'title'=>'Edit',
							'icon'=>'edit',
							'url'=>'op/edit_element/edit_info/~current_element~',
					),
					'back'=>array(
							'label'=>'',
							'title'=>'Close',
	...
	$operations['remove_info']=array(
			...
			'redirect_after_delete'=>'op/entity_list/list_info',
