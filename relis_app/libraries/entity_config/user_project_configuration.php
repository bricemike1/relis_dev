...
function get_user_project() {
		...
		$fields['userproject_active']=array(
	   	...
	   	$operations['add_userproject']=array(
	   			...
	   			'redirect_after_save'=>'op/entity_list/list_user_projects',
	   	...
	   	$operations['list_userprojects']=array(
	   			...
	   			'list_links'=>array(
	   					'view'=>array(
									...
									'icon'=>'folder',
									'url'=>'op/display_element/detail_userproject/',
								),
						'edit'=>array(
									'label'=>'Edit',
									'title'=>'Edit',
									'icon'=>'edit',
									'url'=>'op/edit_element/edit_userproject/',
								),
						'delete'=>array(
									'label'=>'Delete',
									'title'=>'Delete the user',
									'url'=>'op/delete_element/remove_userproject/'
								)
	   			...
	   			'top_links'=>array(
							'add'=>array(
										...
										'icon'=>'add',
										'url'=>'op/add_element/add_userproject',
									),
							'close'=>array(
										'label'=>'',
										'title'=>'Close',
		...
		$operations['remove_userproject_c']['redirect_after_delete']='op/display_element/detail_user/~current_element~';
