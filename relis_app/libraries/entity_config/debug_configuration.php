...
function get_config_debug() {
		...
		$operations['add_debug']=array(
			...
			'redirect_after_save'=>'op/entity_list/list_debug',
		...
		$operations['list_debug']=array(
				...
				'fields'=>array(
						'title'=>array('link'=>array(
								'url'=>'op/display_element/detail_debug/',
								'id_field'=>'debug_id',
								'trim'=>'0'
							)),
						//'title'=>array(),
				...
				'list_links'=>array(
						'delete'=>array(
									...
									'url'=>'op/delete_element/remove_debug/')
		...
		$operations['detail_debug']=array(
				...
				'top_links'=>array(
						'edit'=>array(
									...
									'title'=>'Edit',
									'icon'=>'edit',
									'url'=>'op/edit_element/edit_debug/~current_element~',
								),	
						'back'=>array(
										'label'=>'',
										'title'=>'Close',
		...
		$operations['remove_debug']=array(
				...
				'redirect_after_delete'=>'op/entity_list/list_debug',
