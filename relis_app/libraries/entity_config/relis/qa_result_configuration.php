...
function get_qa_result() {
		...
		$operations['add_qa_result']=array(
			...
			'redirect_after_save'=>'op/entity_list/list_qa_result',
		...
		$operations['list_qa_result']=array(
				...
				'list_links'=>array(
						'view'=>array(
									...
									'icon'=>'folder',
									'url'=>'op/display_element/detail_qa_result/',
								),
						'edit'=>array(
									'label'=>'Edit',
									'title'=>'Edit',
									'icon'=>'edit',
									'url'=>'op/edit_element/edit_qa_result/',
								),
						'delete'=>array(
									'label'=>'Delete',
									'title'=>'Delete ',
									'url'=>'op/delete_element/remove_qa_result/'
								)
				...
				'top_links'=>array(
							'add'=>array(
										...
										'title'=>'Add new',
										'icon'=>'add',
										'url'=>'op/add_element/add_qa_result',
									),
							'close'=>array(
										'label'=>'',
										'title'=>'Close',
		...
		$operations['detail_qa_result']=array(
				...
				'top_links'=>array(
						'edit'=>array(
									...
									'title'=>'Edit',
									'icon'=>'edit',
									'url'=>'op/edit_element/edit_qa_result/~current_element~',
								),	
						'back'=>array(
										'label'=>'',
										'title'=>'Close',
		...
		$operations['remove_qa_result']=array(
				...
				'redirect_after_delete'=>'op/entity_list/list_qa_result',
