...
function get_screening_decision() {
		...
		$fields['decision_source']=array(
	   			...
	   			'input_type'=>'select',
	   			'input_select_source'=>'array',
	   			'input_select_values'=>array('new_screen'=>'new_screen',																							
											'edit_screen'=>'edit_screen',												
											'conflict_resolution'=>'conflict_resolution'								
				),
	   	);
		$fields['decision_history']=array(
			'field_title'=>'Decision history', //in json
			'field_type'=>'longtext',	   						
			'field_size'=>2000,	   			
			'input_type'=>'textarea'
		);
		...
		$fields['decision_active']=array(
				...
				'table_display_style'=>'dynamic_table',
	   			...
	   			'list_links'=>array(
	   					'view'=>array(
	   							...
	   							'icon'=>'folder',
	   							'url'=>'op/display_element/display_decision/',
	   					),
	   					'edit'=>array(
	   							'label'=>'Edit',
	   							'title'=>'Edit',
	   							'icon'=>'edit',
	   							'url'=>'op/edit_element/edit_decision/',
	   					),
	   					'delete'=>array(
	   							'label'=>'Delete',
	   							'title'=>'Delete assignment',
	   							'url'=>'op/delete_element/remove_decision/'
	   					)
	   			...
	   			'top_links'=>array(
	   					'add'=>array(
	   							...
	   							'icon'=>'add',
	   							'url'=>'op/add_element/new_decision',
	   					),
	   					'close'=>array(
	   							'label'=>'',
	   							'title'=>'Close',
	   	...
	   	$operations['new_decision']=array(
	   			...
	   			'redirect_after_save'=>'op/entity_list/list_decisions',
