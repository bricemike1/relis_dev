...
function get_config_screen_phase() {
		...
		$fields['phase_history']=array(
			'field_title'=>'Phase history', //in json
			'field_type'=>'longtext',	   						
			'field_size'=>2000,	   			
			'input_type'=>'textarea'
		);
		...
		$operations['add_screen_phase']=array(
			...
			'save_function'=>'op/save_phase_screen',
			'page_template'=>'general/frm_entity',
			'redirect_after_save'=>'op/entity_list/list_screen_phases',
		...
		$operations['detail_screen_phase']=array(
				...
				'top_links'=>array(
						'edit'=>array(
									...
									'title'=>'Edit',
									'icon'=>'edit',
									'url'=>'op/edit_element/edit_screen_phase/~current_element~',
								),	
						'back'=>array(
										'label'=>'',
										'title'=>'Close',
		...
		$operations['remove_screen_phase']=array(
				...
				'redirect_after_delete'=>'op/entity_list/list_screen_phases',
