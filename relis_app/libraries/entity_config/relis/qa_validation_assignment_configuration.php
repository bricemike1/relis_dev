...
function get_qa_validation_assignment() {
		...
		$operations['add_qa_validation_assignment']=array(
			...
			'redirect_after_save'=>'op/entity_list/list_qa_validation_assignment',
		...
		$operations['edit_qa_validation']=array(
				...
				'redirect_after_save'=>'op/entity_list/list_qa_validation',
				'data_source'=>'get_detail_qa_validation_assignment',
				'db_save_model'=>'update_qa_validation_assignment',
				...
				'list_links'=>array(
					/*	'view'=>array(
						...
						'edit'=>array(
									...
									'title'=>'Edit',
									'icon'=>'edit',
									'url'=>'op/edit_element/edit_qa_validation_assignment/',
								),*/
						'delete'=>array(
									'label'=>'Delete',
									'title'=>'Delete ',
									'url'=>'op/delete_element/remove_qa_validation_assignment/'
								)
		...
		$operations['detail_qa_validation_assignment']=array(
				...
				'top_links'=>array(
						'edit'=>array(
									...
									'title'=>'Edit',
									'icon'=>'edit',
									'url'=>'op/edit_element/edit_qa_validation_assignment/~current_element~',
								),	
						'back'=>array(
										'label'=>'',
										'title'=>'Close',
		...
		$operations['remove_qa_validation_assignment']=array(
				...
				'redirect_after_delete'=>'op/entity_list/list_qa_validation_assignment',
